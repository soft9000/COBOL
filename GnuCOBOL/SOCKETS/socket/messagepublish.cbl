...
01 publish-address.
   03  publish-family binary-short unsigned.
   03  publish-port binary-short unsigned.
   03  publish-ip-address binary-int unsigned.
   03  filler pic x(8) value low-values.

01 AF_INET binary-short unsigned value 2.
01 SOCK_DGRAM binary-short unsigned value 2.
...
start-messagepublish.
    ...
    move AF_INET to publish-family
