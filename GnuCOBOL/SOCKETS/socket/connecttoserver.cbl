...
01 address-hints.
   03  address-hints-flags binary-int.
   03  address-hints-family binary-int.
   03  address-hints-socktype binary-int.
   03  address-hints-protocol binary-int.
   03  address-hints-address-length binary-int.
   03  address-hints-address pointer.
   03  address-hints-canonname pointer.
   03  address-hints-next pointer.
01 getaddrinfo-result pointer.
01 address-info-pointer pointer.
01 address-info based.
   03  address-info-flags binary-int.
   03  address-info-family binary-int.
   03  address-info-socktype binary-int.
   03  address-info-protocol binary-int.
   03  address-info-address-length binary-int.
   03  address-info-address pointer.
   03  address-info-canonname pointer.
...
*>   get the linked list of selected addresses for this host and host-service
