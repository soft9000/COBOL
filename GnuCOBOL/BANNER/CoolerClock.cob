...
*> GnuCOBOL: cobc -x -j -free CoolerClock.cob
...
PERFORM FOREVER
    ...
    IF RASTER_SUCCESS
        *> INSPECT RASTER_BUFFER REPLACING ALL ' ' BY ':'
        INSPECT RASTER_BUFFER REPLACING ALL 'X' BY '@' *> New! (Commons)
...
DISPLAY_COLORIZED.
    DISPLAY NINE_LINES(RASTER_SS) AT LINE RASTER_SS COLUMN 5 
