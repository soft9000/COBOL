*> Mission: Show how LINKAGE WRITING is POSSIBLE. Constants in LS to be avoided!
...
COPY "BIG_CHARS3.cpy".
COPY "CB_RETURN_CODES.cpy". *> KEEP OUT OF LINKAGE (GnuCOBOL, only?)
...
MOVE CODE_SUCCESS TO RASTER_RETURN_CODE.
*> TODO: Why not just raster to NINE_LINES?
PERFORM VARYING RASTER_LINE_SS FROM 1 BY 1 UNTIL RASTER_LINE_SS = 9
