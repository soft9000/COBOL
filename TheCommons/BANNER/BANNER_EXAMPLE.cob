...
01 BANNER_FIELD PIC X(8) VALUE '????????'.
01 BANNER_ARRAY 
   REDEFINES BANNER_FIELD OCCURS 8 TIMES 
   INDEXED BY BANNER_ARRAY_SS.
   05 FILLER PIC X.

01 RASTER_BUFFER PIC X(648) VALUE SPACES.
01 RASTER_SEG REDEFINES RASTER_BUFFER OCCURS 72 TIMES
   INDEXED BY RASTER_SEG_SS.
   05 FILLER PIC X(9).

01 RASTER_LINE REDEFINES RASTER_BUFFER OCCURS 9 TIMES
