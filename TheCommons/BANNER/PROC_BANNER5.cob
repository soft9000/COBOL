*> Mission: Demonstrate communicating with a 'significant' procedure.
*> GnuCOBOL: cobc -free PROC_BANNER5.cob
...
DISPLAY ' '.
EXIT PROGRAM RETURNING CODE_SUCCESS.
