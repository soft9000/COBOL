*> Mission: Show how RETURNING a COMPLEX STRUCTURE is POSSIBLE.
...
COPY 'CB_RASTER_GROUP.cpy'. *> New: Complex Structure
...
MOVE RASTER_SUCCESS_CODE TO RASTER_RETURN_CODE.
...
END-PERFORM
EXIT PROGRAM RETURNING RASTER-RESULTS. *> New!
